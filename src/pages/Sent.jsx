...
const Sent = () => {
  ...
  const { setTransfers } = useContext(Context);
  ...
  const handleSetPassword = (transferPassword) => {
    if (transferPassword === "") return toast.error("Please Enter Password");
    setLoader((prev) => ({ ...prev, updatePassLoading: true }));
    dispatch(
      updateTransferPassowrd({
      ...
      <div className="box-border">
        ...
        <div className="flex flex-row border-b-[0.0625em] border-[rgb(232,235,237)] pb-[1.5625em] justify-between box-border">
          ...
          <div className=" relative w-full flex gap-5 justify-end box-border">
            ...
            <button
              onClick={(e) => handleDeleteTransfer(e)}
              className=" border-none text-[rgb(82,104,255)] cursor-pointer inline-block relative bg-[rgba(0,0,0,0)] outline-0 "
            >
              {loading && loaders?.deleteLoading ? (
                <svg
                  className="animate-spinner-rotate origin-center  h-[1.5rem] w-[1.5rem] left-[20%] absolute translate-x-[-50%] box-border text-[rgb(82,104,255)]"
                  shape-rendering="geometricPrecision"
                  viewBox="0 0 170 170"
                >
                  <circle
                ...
                <div className=" w-full box-border">
                  {showPassInput ? (
                      ...
                      <div className="flex flex-row items-center gap-[.5rem] box-border">
                        <span className=" box-border">
                          <button
                            ...
                            className="p-0 h-auto m-0 bg-none border-0 outline-none font-medium rounded-[5px] text-[.875em] relative noun'  text-[#fff] box-border transition-[border-color,background-color,color] duration-[0.2s] ease-[cubic-bezier(.77,0,.175,1)]"
                          >
                            {loaders.updatePassLoading && loading ? (
                              <svg
                                className="animate-spinner-rotate origin-center w-6 h-6 box-border outline-none text-[.875em]"
                                shape-rendering="geometricPrecision"
                                viewBox="0 0 170 170"
                              >
                                <circle
                        ...
                        <span className="box-border">
                          ...
                          >
                            <svg
                              className="w-6 h-6 box-border outline-none cursor-pointer  fill-[rgb(106,109,112)] hover:fill-[#5268ff]"
                              viewBox="0 0 24 24"
                              data-testid="close-icon"
                            >
                              <path
                    ...
                    <div className=" inline-flex items-center box-border">
                      <span className=" mr-[.3125rem] block box-border">
                        <img
                          src="data:image/svg+xml;base64,"
                          className="w-[10px] h-[10px] block"
                        ></img>
                      </span>
                      <span className=" font-normal text-[#484a4d] text-[.875rem] leading-[1.4] mt-0 box-border">
                        Added
                      </span>
                      <button
                        onClick={() => setShowPassInput(true)}
                        className=" ml-2 cursor-pointer underline border-0 bg-none p-0 font-normal text-[#484a4d] text-[.875rem] leading-[1.4] mt-0 after:inline-block after:px-2 after:no-underline after:content-['·']"
                      >
                        Change
                      </button>
                      <button
                        ...
                        className="cursor-pointer underline border-0 bg-none p-0 font-normal text-[#484a4d] text-[.875rem] leading-[1.4] mt-0"
                      >
                        Remove
                      </button>
                    </div>

...
const PageFooter = () => {
  return (
    <footer className="mx-[2.5rem] border-t border-[#e6e8eb] shadow-none flex h-aut0 gap-[20px] justify-between pt-5 px-0 pb-4 w-auto items-center box-border">
      <div className="flex gap-4 relative items-center w-full box-border">
        <button className="ml-8 font-normal flex items-center text-[#464646] text-[.875rem] no-underline align-top cursor-pointer relative select-none border-0 p-0 before:content-[''] before:block before:h-[1.1428571429em] before:w-[1.1428571429em] before:absolute before:top-[0.1428571429em] before:left-[-1.9285714286em] before:bg-[url('https://cdn.wetransfer.com/_next/static/media/globe.1603f8a7.svg')]">
          English
          <svg
            className=" h-[.625rem] relative top-0 w-[.625rem] m-0 ml-[.3125rem] left-[.09375rem] p-0 align-baseline rotate-[270deg] box-border font-normal text-[#464646] text-[.875rem]  cursor-pointer select-none"
            viewBox="-1 14 9 12"
          >
            <path
              stroke="#6a6d70"
        ...
        <nav className="flex flex-wrap gap-[.625rem] ml-8 box-border">
          <a className=" font-normal text-[#464646] text-[.875rem] m-0 no-underline align-middle box-border">
            Terms
          </a>
          <a className=" font-normal text-[#464646] text-[.875rem] m-0 no-underline align-middle box-border">
            Privacy
      ...
      <div className="flex gap-4 items-baseline box-border">
        <a className=" ml-0 no-underline">
